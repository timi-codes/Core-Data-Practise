...
class NotebooksListViewController: UIViewController, UITableViewDataSource {
    ...
    var fectchedResultController:NSFetchedResultsController<Notebook>!
    ...
    func addNotebook(name: String) {
        ...
        notebook.name = name
        try? dataController.viewContext.saveWithCheck()
    ...
    func deleteNotebook(at indexPath: IndexPath) {
        let removeNotebook = notebooks[indexPath.row]
        dataController.viewContext.delete(removeNotebook)
        try? dataController.viewContext.saveWithCheck()
